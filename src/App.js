...
function App() {
  return (
    <Router>
      <MetaDecorator description="Join us for a fantasic Janmashtami celebration in Amsterdam!" title="Janmashtami 2022 ISKCON Amsterdam" imgUrl="/Diwali/sitaram2.jpeg" imgAlt="Janmashtami Celebration in Amsterdam!"/>
      <Switch>
